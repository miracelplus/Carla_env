...
class Vehicle(Loggable):
    ...
    # Haowei added 20191125
    # ENV use it to check the collision and responsibility, this function will not fuck the condition of the vehicle, and does not care the vehicle's condition, just return whether two vehicles collapse
