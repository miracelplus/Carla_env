...
from highway_env.vehicle.behavior import IDMVehicle, IDMVehicle_CAV
...
class VehicleGraphics(object):
    ...
    def get_color(cls, vehicle, transparent=False):
        ...
        if vehicle.crashed:
            color = cls.RED
        # Haowei modify 20191019
        elif vehicle.controlled:
            color = cls.PURPLE
        elif isinstance(vehicle, IDMVehicle_CAV):
            color = cls.YELLOW
        elif vehicle.IDM_flag:
            color = cls.GREEN
